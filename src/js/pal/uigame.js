...
utils.extend(uigame, {
   ...
   * 绘制开场菜单背景
   */
  drawOpeningMenuBackground: function*() {
   ...
   * @return {Promise}
   */
  saveSlotMenu: function*(defaultSlot) {
    var boxes = [],
        menu = [],
  ...
  systemMenu_onItemChange: function(currentItem) {
  ...
  inGameMenu_onItemChange: function(currentItem) {
  ...
  itemUseMenu: function*(itemToUse) {
  ...
  buyMenu_onItemChange: function(currentItem) {
  ...
  sellMenu_onItemChange: function(currentItem) {
    // Draw the cash amount
